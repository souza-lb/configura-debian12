...
# Configurar .nanorc
configurar_arquivo "$HOME/.nanorc" "$HOME/.nanorc" "$pasta_config/nanorc"
...
# Configurar Geany
configurar_arquivo "$HOME/.config/geany/geany.conf" "$HOME/.config/geany/geany.conf" "$pasta_config/geany.conf"
configurar_arquivo "$HOME/.config/geany/colorschemes/one-dark.conf" "$HOME/.config/geany/colorschemes/one-dark.conf" "$pasta_config/one-dark.conf"

# Configurar Bluefish
configurar_arquivo "$HOME/.bluefish/rcfile-2.0" "$HOME/.bluefish/rcfile-2.0" "$pasta_config/rcfile-2.0"

# Configurar xfce4-terminal
configurar_arquivo "$HOME/.config/xfce4/terminal/terminalrc" "$HOME/.config/xfce4/terminal/terminalrc" "$pasta_config/terminalrc"
